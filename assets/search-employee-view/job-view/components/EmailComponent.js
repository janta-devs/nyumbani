  ...
  render(){
    ...
    <div className="form-group label-floating">
          ...
          <div className="mdl-textfield mdl-js-textfield">
            ...
            <button className = "mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored" onClick = {this.handleSend}>Send Message</button>
          </form>
        </div>
    )
  }
...
class EmailComponent extends Component {
  ...
  render(){
    if(this.state.MessageSent === false ){
      return ( 
          <div>
            <Form handleSend = {this.handleSend.bind(this)} userLogin = {this.props.data.data.login_id}/>
          </div>                     
      );
    }
    else
